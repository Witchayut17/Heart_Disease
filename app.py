...
with col_right:
    ...
    with st.expander("ข้อมูลสรุปและวิธีกรอกข้อมูล", expanded=True):
        ...
        with col_a:
            ...
            - thal (ภาวะธาลัสซีเมีย): ปกติ หรือ ข้อบกพร่องเล็กน้อย  
        ...
        with col_b:
            ...
            - thal (ภาวะธาลัสซีเมีย): ข้อบกพร่องถาวร หรือ กลับคืนได้  
            - ca (จำนวนเส้นเลือดใหญ่ที่ตีบ): 1-2  
            - cp (ประเภทอาการเจ็บหน้าอก): 2-3  
                - 2: เจ็บแน่นหน้าอกแบบ atypical angina  
                - 3: เจ็บหน้าอกแบบไม่เกี่ยวกับหัวใจ (non-anginal pain)  
        ...
        with col_c:
            ...
            - thal (ภาวะธาลัสซีเมีย): ข้อบกพร่องถาวร หรือ กลับคืนได้  
                - 6: ข้อบกพร่องถาวร (fixed defect)  
                - 7: ข้อบกพร่องกลับคืนได้ (reversible defect)  
            - ca (จำนวนเส้นเลือดใหญ่ที่ตีบ): 3  
            - cp (ประเภทอาการเจ็บหน้าอก): 3-4  
                - 3: เจ็บหน้าอกแบบไม่เกี่ยวกับหัวใจ  
                - 4: เจ็บหน้าอกแบบรุนแรง (asymptomatic หรือ serious chest pain)  
